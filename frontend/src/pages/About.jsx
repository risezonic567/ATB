      ...
      <motion.div initial="hidden" animate="show" variants={containerVariants}>
        ...
        <section className="py-12 md:py-16 bg-gray-50 text-gray-800">
          <div className="container mx-auto px-4 md:px-6 max-w-5xl text-center">
            ...
            <motion.p variants={itemVariants} className="text-sm sm:text-base md:text-lg leading-relaxed text-gray-600 mb-4">
            ...
            <motion.p variants={itemVariants} className="text-sm sm:text-base md:text-lg leading-relaxed text-teal-600 font-semibold">
        ...
        <section className="py-12 md:py-16 bg-white text-gray-800">
          <div className="container mx-auto px-4 md:px-6 max-w-5xl space-y-12 md:space-y-16">
            ...
            <motion.h2 
              variants={itemVariants} 
              className="text-2xl md:text-3xl font-bold text-center uppercase tracking-wide mb-2 text-gray-900"
            >
              OUR STORY
            </motion.h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-center">
              ...
              <motion.div variants={itemVariants} className="w-full">
                <img
                  ...
                  className="rounded-2xl shadow-xl object-cover w-full aspect-video md:aspect-auto h-64 md:h-80"
                />
              </motion.div>
              
              {/* Right Text */}
              <motion.div variants={itemVariants} className="text-sm sm:text-base space-y-4 leading-relaxed text-gray-600">
                <p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-center">
              {/* Left Text */}
              <motion.div variants={itemVariants} className="text-sm sm:text-base space-y-4 leading-relaxed text-gray-600 order-2 md:order-1">
                <p>
              ...
              {/* Right Image */}
              <motion.div variants={itemVariants} className="order-1 md:order-2 w-full">
                <img
        ...
        <section className="py-12 md:py-16 bg-gray-50 text-gray-800">
          <div className="container mx-auto px-4 md:px-6 max-w-4xl">
            <motion.h2 variants={itemVariants} className="text-2xl md:text-3xl font-bold text-center uppercase tracking-wide mb-4 text-gray-900">
              OUR MISSION
            </motion.h2>
            <motion.p variants={itemVariants} className="text-base md:text-lg text-center text-gray-700 font-medium mb-8 max-w-2xl mx-auto">
              To ensure every American citizen gets to enjoy affordable and hassle-free air travel experience.
            </motion.p>
            <motion.div variants={itemVariants} className="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100">
              <p className="font-semibold mb-4 text-gray-800 text-base md:text-lg">This we achieve through:</p>
              <ul className="space-y-3 text-sm sm:text-base text-gray-600 list-none pl-0">
        ...
        <section className="py-12 md:py-16 bg-white text-gray-800">
          <div className="container mx-auto px-4 md:px-6 max-w-5xl">
            <motion.div variants={itemVariants} className="text-center mb-10">
              <h2 className="text-xl md:text-2xl font-semibold text-[#C30000] uppercase tracking-wider">What makes us unique?</h2>
              <h3 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 leading-tight">Why Travellers Choose AirlinesTicketBooking?</h3>
            </motion.div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              <motion.div variants={itemVariants} className="bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-xs">
                <h4 className="text-lg md:text-xl font-bold text-gray-900 mb-2">Comprehensive Airline Coverage</h4>
              ...
              <motion.div variants={itemVariants} className="bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-xs">
                <h4 className="text-lg md:text-xl font-bold text-gray-900 mb-2">Human-Powered Support</h4>
                <p className="text-gray-600 text-sm leading-relaxed">
              ...
              <motion.div variants={itemVariants} className="bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-xs">
                <h4 className="text-lg md:text-xl font-bold text-gray-900 mb-2">No Secrets</h4>
                <p className="text-gray-600 text-sm leading-relaxed">
              ...
              <motion.div variants={itemVariants} className="bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-xs">
                <h4 className="text-lg md:text-xl font-bold text-gray-900 mb-2">Unbeatable Deals</h4>
                <p className="text-gray-600 text-sm leading-relaxed">
              ...
              <motion.div variants={itemVariants} className="bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-xs md:col-span-2">
                <h4 className="text-lg md:text-xl font-bold text-gray-900 mb-2">Education & Insights</h4>
                <p className="text-gray-600 text-sm leading-relaxed">
        ...
        <section className="py-12 md:py-16 bg-gray-50 text-gray-800">
          <div className="container mx-auto px-4 md:px-6 max-w-5xl">
            <motion.h2 variants={itemVariants} className="text-2xl md:text-3xl font-bold text-center uppercase tracking-wide mb-10 text-gray-900">
              OUR VALUES
            </motion.h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              {[
                ...
                <motion.div key={idx} variants={itemVariants} className="bg-white p-6 rounded-xl shadow-xs border-t-4 border-blue-500">
                  <h4 className="text-base md:text-lg font-bold text-gray-900 mb-2">{val.title}</h4>
                  <p className="text-xs md:text-sm text-gray-600 leading-relaxed">{val.text}</p>
                </motion.div>
              ))}
            </div>
          </div>
        ...
        {/* CONTACT AIRLINESTICKETBOOKING - Prevent String Wrapping Issues */}
        <section className="py-12 md:py-16 bg-blue-900 text-white">
          <div className="container mx-auto px-4 md:px-6 max-w-4xl text-center">
            <motion.h2 variants={itemVariants} className="text-2xl md:text-3xl font-bold uppercase tracking-wide mb-4">
              CONTACT AIRLINESTICKETBOOKING
            </motion.h2>
            <motion.p variants={itemVariants} className="text-sm md:text-base text-blue-200 mb-8 max-w-xl mx-auto">
              Have questions? Want to book over the phone? Our travel experts are ready.
            </motion.p>
            <motion.div variants={itemVariants} className="bg-white/10 backdrop-blur-md max-w-2xl mx-auto p-4 sm:p-8 rounded-2xl border border-white/20 text-left space-y-4">
              <div className="text-sm sm:text-base md:text-lg flex flex-col sm:flex-row sm:justify-between border-b border-white/10 pb-3 gap-1 sm:gap-0">
                <span className="font-semibold text-blue-300">AirlinesTicketBooking Contact Number:</span> 
                <span className="font-bold whitespace-nowrap">+(866)307-5957</span>
              </div>
              <div className="text-sm sm:text-base md:text-lg flex flex-col sm:flex-row sm:justify-between border-b border-white/10 pb-3 gap-1 sm:gap-0">
                <span className="font-semibold text-blue-300">Email:</span> 
                <span className="break-all sm:break-normal">support@airlinesticketbooking.com</span>
              </div>
              <div className="text-sm sm:text-base md:text-lg flex flex-col sm:flex-row sm:justify-between border-b border-white/10 pb-3 gap-1 sm:gap-0">
                <span className="font-semibold text-blue-300">Website:</span> 
                <span className="url-link">www.airlinesticketbooking.com</span>
              </div>
              <div className="text-sm sm:text-base md:text-lg flex flex-col sm:flex-row sm:justify-between gap-1 sm:gap-0">
