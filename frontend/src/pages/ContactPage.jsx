...
export default function ContactPage() {
  ...
  const sendMail = async (e) => {
    ...
    try {
      ...
      await emailjs.sendForm(
        "service_p529e7l", //service id
        "template_58z3sdn", //templ
        form.current,
        "BO5wYb7DlJ95XgXzG", //public id
      );
  ...
  const contactDetails = [
    ...
    },
    {
      ...
      title: "Email Support",
      detail: "support@airlinesticketbooking.com",
      link: "mailto:support@airlinesticketbooking.com",
    },
    {
      icon: <MapPin className="w-6 h-6 text-teal-600" />,
      title: "Address",
      detail: "17662 Irvine Blvd, Suite 9 Tustin, CA 92780)",
      link: "#",
    },
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Contact Airlines Ticket Booking USA | Travel Support</title>
        <meta
          name="description"
          content="Contact our US travel agency experts for flight bookings, hotel deals, visa assistance, travel insurance tour packages and support with your travel plans."
        />
        <link
          rel="canonical"
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <motion.div variants={fadeUp} className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">
              Contact Airlines Ticket Booking Travel Support Team
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Whether you need to book a new flight, modify an existing
              reservation, or have a question about airfare deals, our team is
              here for you.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            >
              ...
              <form className="space-y-6" ref={form} onSubmit={sendMail}>
                ...
                <p className="text-sm text-gray-500 mt-4">
                  *For urgent booking assistance, please call us directly for
